...
interface CliCommandCodeInternalProps {
    commands: {
        label: string;
        code: string;
    }[];
...
export function CliCommandCodeInternal({ commands }: CliCommandCodeInternalProps) {
    const [selectedTab, setSelectedTab] = useLocalStorage("cli-method", commands[0].label);
